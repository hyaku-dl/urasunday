...
`cao(group: <function group at 0x7f9d0e06d480>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f9d0e06d480>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
