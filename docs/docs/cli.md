...
`cao(group: <function group at 0x7fdfb31a8820>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fdfb31a8820>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
