...
`cao(group: <function group at 0x7f5527edc700>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f5527edc700>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
