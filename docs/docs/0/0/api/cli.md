...
`cao(group: <function group at 0x7f8cf7c18940>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f8cf7c18940>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
