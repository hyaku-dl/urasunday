...
`cao(group: <function group at 0x7f5bd2404940>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f5bd2404940>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
