...
`cao(group: <function group at 0x7f30a2b1cca0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f30a2b1cca0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
