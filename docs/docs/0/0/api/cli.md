...
`cao(group: <function group at 0x7feaf2110940>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7feaf2110940>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
