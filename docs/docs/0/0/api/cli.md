...
`cao(group: <function group at 0x7fa0f4e0c940>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7fa0f4e0c940>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
