...
`cao(group: <function group at 0x7f9569414940>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f9569414940>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
