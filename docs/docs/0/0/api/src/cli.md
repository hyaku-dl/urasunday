...
`cao(group: <function group at 0x7f05c275d3f0>, cmd: str) ‑> List[Callable[[Callable[[Any], Any]], Callable[[Any], Any]]]`
...
`command(group: <function group at 0x7f05c275d3f0>) ‑> Callable[[Callable[[Any], Any]], Callable[[Any], Any]]`
