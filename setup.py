...
setup(
    ...
    version='0.0.0.0-alpha.4',
    description='A Basic Urasunday Scraper',
    long_description='''A no-nonsense, simple and easy to use scraper for urasunday.com.
    ...
    install_requires=['rich', 'aiofiles', 'arrow', 'bs4', 'click', 'eventlet', 'httpx', 'inquirer', 'lxml', 'msgpack', 'patool', 'python-socketio', 'pyyaml', 'tabulate', 'toml', 'tqdm', 'yachalk', 'yarl'],
    entry_points = {
